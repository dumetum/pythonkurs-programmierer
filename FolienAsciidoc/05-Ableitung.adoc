...
ifdef::beispiele[]
== Beispiel Ableitungen von Konto-Klasse
[source,python]
----
include::../Beispiele/Kapitel_5/konto_giro_spar.py[]
----
== &#8239;
== &#8239;
endif::beispiele[]
...
ifdef::beispiele[]
== Beispiel Mehrfachableitung
[source,python]
----
include::../Beispiele/Kapitel_5/mehrfach.py[]
----
== &#8239;
endif::beispiele[]
...
ifdef::beispiele[]
== Beispiel Ableitung von Standardklasse
[source,python]
----
include::../Beispiele/Kapitel_5/plist.py[]
----
endif::beispiele[]
